module EOEinBLG
    ...
    # function  __init__()    # MKL routines may offer a slight speed up
    ...
    export Params, snshamiltonian, snshelicalhamiltonian, fraunhofer_abs_exact, icϕ_exactdiag, 
        ...
        spectrumvsmunnbands, savecsv, spectrumvsτnlink,Jcsweepvsmuvacbands, Jcsweepvsmu, Jcsweepvstaunlink, Jcsweepvsdelta, Jcsweepvstauns,
        spectrumvsmuvac
end